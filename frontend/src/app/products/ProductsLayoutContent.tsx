...
// This component handles the layout for the products page, including the breadcrumb, heading, and aside navigation.
export default function ProductsLayoutContent({
  children,
}: {
  children: ReactNode;
}) {
  return (
    <Suspense fallback={<div className="padding-inline py-40" />}>
      <ProductsLayoutView>{children}</ProductsLayoutView>
    </Suspense>
  );
}
